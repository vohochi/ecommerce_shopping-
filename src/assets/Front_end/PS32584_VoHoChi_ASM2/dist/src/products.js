...
class ProductModel {
    getAll(queryParams) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch(`${url}/products/paginations?page=${queryParams}`);
    ...
    create(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const data1 = yield fetchAPI(`${url}products/add`, {
                method: 'POST',
                body: data,
            });
            if (!data1) {
    ...
    update(id, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const data1 = yield fetchAPI(`${url}products/update/${id}`, {
                method: 'PUT',
                body: data,
            });
            if (!data1) {
...
${product.name}                        </h5>
                    ...
                    <div class="btn-group" role="group">
                      <a 
                        class="btn btn-sm btn-white"
                            href="ecommerce-product-details.html?editPro=${product.id}"
                      >
  ...
  `;
    ...
    .catch((error) => { });
function populatePaginationSelect(totalPages) {
    const selectElement = document.getElementById('datatableEntrie');
